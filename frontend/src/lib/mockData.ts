...
// mockDocs retained for snapshot/reference purposes; the real document list is
// fetched from the backend. Shape matches the backend DocumentItem contract.
export const mockDocs: Doc[] = [
  {
    ...
    parseStatus: "ready",
    lastProcessedAt: "2026-04-18T10:05:00.000Z",
    currentVersion: {
      id: "ver-1",
      status: "ready",
      parseRevision: 1,
      ...
      sourceLabel: null,
      createdAt: "2026-04-18T10:00:00.000Z",
      processedAt: "2026-04-18T10:05:00.000Z",
      isCurrent: true,
    },
  },
  {
    ...
    parseStatus: "ready",
    lastProcessedAt: "2026-04-17T10:05:00.000Z",
    currentVersion: {
      id: "ver-2",
      status: "ready",
      parseRevision: 1,
      ...
      sourceLabel: null,
      createdAt: "2026-04-17T10:00:00.000Z",
      processedAt: "2026-04-17T10:05:00.000Z",
      isCurrent: true,
    },
  },
  {
    id: "3",
    projectId: "mock-project",
    title: "Tech Architecture Reference",
    kind: "reference",
    visibility: "internal",
    createdAt: "2026-04-16T10:00:00.000Z",
    updatedAt: "2026-04-16T10:00:00.000Z",
    parseStatus: "ready",
    lastProcessedAt: "2026-04-16T10:05:00.000Z",
    currentVersion: {
      id: "ver-3",
      status: "ready",
      parseRevision: 1,
      ...
      sourceLabel: null,
      createdAt: "2026-04-16T10:00:00.000Z",
      processedAt: "2026-04-16T10:05:00.000Z",
      isCurrent: true,
    },
  },
  {
    ...
    parseStatus: "ready",
    lastProcessedAt: "2026-04-15T10:05:00.000Z",
    currentVersion: {
      id: "ver-4",
      status: "ready",
      parseRevision: 1,
      ...
      sourceLabel: null,
      createdAt: "2026-04-15T10:00:00.000Z",
      processedAt: "2026-04-15T10:05:00.000Z",
      isCurrent: true,
    },
  },
  {
